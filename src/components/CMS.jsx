                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-gray-500 dark:text-gray-400 mt-1 leading-normal">
                        Insert your OpenRouter key to enable LLM-powered responses via <strong>poolside/laguna-m.1:free</strong>.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                        This response is used as the general offline response if the OpenRouter call fails.
                      </p>
                    </div>
                  </div>
                </div>
